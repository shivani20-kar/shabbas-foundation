...
import heroImage from "../ShabbasKattaPage/Images/shabbaskattahero.jpg";
      ...
      <div className="shabbaskattaheroContainer">
        ...
        <div className="shabbaskattaheroLeft">
          ...
          <p className="shabbaskattaheroDescription">
            शाब्बास अकॅडमी घेऊन येत आहे एक खास डिजिटल मंच जिथे
            विद्यार्थी, शिक्षक आणि पालक एकत्र येतात - ज्ञान,
            अनुभव आणि प्रेरणा शेअर करण्यासाठी.
          </p>
          ...
          <button className="shabbaskattaheroButton">
            परीक्षा नोंदणी करा
          </button>
